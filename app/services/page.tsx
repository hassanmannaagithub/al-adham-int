  ...
  return (
    <div className="min-h-screen pt-40 bg-[#ccc0a5]">
      ...
      <div className="text-center mt-4 md:mt-8">
        <h1 className="text-4xl md:text-super-title font-light text-center pt-2 md:pt-4 tracking-widest">OUR SERVICES</h1>
      </div>
      ...
      <div className="pt-12 md:pt-20 tracking-widest px-4 md:px-0">
        ...
        <div className="text-center space-y-1">
          <p className="text-[#222222] text-lg md:text-2xl">Story Ideation & Development</p>
          <p className="text-[#222222] text-lg md:text-2xl">Scriptwriting & Editing</p>
          <p className="text-[#222222] text-lg md:text-2xl">Series Bible & Character Development</p>
        </div>
      ...
      <div className="pt-12 md:pt-20 tracking-widest bg-[#dcd3bf] px-4 md:px-0">
        ...
        <div className="text-center space-y-1 md:space-y-2">
          <p className="text-[#222222] text-lg md:text-2xl">Casting & Talent Acquisition</p>
          <p className="text-[#222222] text-lg md:text-2xl">Location Scouting & Set Design</p>
          <p className="text-[#222222] text-lg md:text-2xl">Budgeting & Scheduling</p>
          <p className="text-[#222222] text-lg md:text-2xl">Production Design & Costume Styling</p>
        </div>
      ...
      <div className="pt-12 md:pt-28 tracking-widest px-4 md:px-0">
        ...
        <div className="text-center space-y-1">
          <p className="text-[#222222] text-lg md:text-2xl">Cinematic Filming & Directing</p>
          <p className="text-[#222222] text-lg md:text-2xl">High-Quality Cinematography</p>
          <p className="text-[#222222] text-lg md:text-2xl">Production Management</p>
        </div>
      ...
      <div className="relative pt-12 md:pt-24 pb-10 tracking-widest bg-[url('/services/services-bg.webp')] bg-cover bg-bottom px-4 md:px-0">
        ...
        <div className="relative text-center space-y-1">
          <p className="text-[#222222] text-lg md:text-2xl">Video Editing & Color Grading</p>
          <p className="text-[#222222] text-lg md:text-2xl">Sound Design & Music Scoring</p>
          <p className="text-[#222222] text-lg md:text-2xl">Visual Effects (VFX) & CGI</p>
          <p className="text-[#222222] text-lg md:text-2xl">Subtitling & Localization</p>
        </div>
